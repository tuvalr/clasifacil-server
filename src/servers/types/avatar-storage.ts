...
export interface AvatarStorage {
	// role/id namespace the key so household and operator avatars never collide; extension is derived from the upload's mime type.
	save(role: 'household' | 'operator', id: number, buffer: Buffer, extension: string): Promise<string>;
