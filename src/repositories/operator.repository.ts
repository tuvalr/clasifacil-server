...
export class OperatorRepository {
	...
	public async create(data: { name: string; email: string; phone: string; countryCode: string; type: 'schedule' | 'assigned'; timezone: string }, tx?: TransactionHandle): Promise<Operator> {
		const db = tx ?? this.db;
